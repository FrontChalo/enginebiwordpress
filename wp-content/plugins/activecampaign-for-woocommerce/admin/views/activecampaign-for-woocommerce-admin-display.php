...
$activecampaign_for_woocommerce_sync_batch_limit              = 100;
		...
		<section class="no-connection">
			...
			<section id="manualsetup" style="display:none">
				<form method="POST" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>"
					...
					<input type="hidden" id="sync_batch_runs" name="sync_batch_runs" value="10">
					<input type="hidden" id="sync_batch_limit" name="sync_batch_limit" value="100">
